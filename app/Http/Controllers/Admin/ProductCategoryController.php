...
{
    private $titleSingle = 'product_category';
    private $titlePlural = 'product_categories';
    private $resourceRoute = 'product_categories';
    private $resourceView = 'product_category';
    ...
    public function create()
    {
        ...
        $this->data['breadcrumbs'] = $breadcrumbs;
        $this->data['parent'] = $this->getParentArray();
    ...
    public function store(Request $request)
    {
        ...
        $input['url_rewrite'] = to_url($input['name']);
