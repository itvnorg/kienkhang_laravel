...
{
    private $titleSingle = 'district';
    private $titlePlural = 'districts';
    private $resourceRoute = 'districts';
    private $resourceView = 'district';
    private $iconMain = 'fa fa-arrows-alt';
    private $model;
    private $modelParent;

    public function __construct(District $model, Province $modelParent){
        parent::__construct();
        $this->model = $model;
