...
{
    private $titleSingle = 'ward';
    private $titlePlural = 'wards';
    private $resourceRoute = 'wards';
    private $resourceView = 'ward';
    private $iconMain = 'fa fa-arrows-alt';
    private $model;
    private $modelParent;

    public function __construct(Ward $model, District $modelParent){
        parent::__construct();
        $this->model = $model;
