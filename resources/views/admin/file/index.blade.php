	...
	<table cellspacing="0" class="table table-bordered table-hover" id="dataTable" width="100%">
		<thead>
			<tr>
				...
				<th>ID</th>
				<th>@lang('admin.preview')</th>
				<th>@lang('admin.file_name')</th>
				<th>@lang('admin.file_type')</th>
				<th>@lang('admin.category')</th>
				<th>@lang('admin.file_path')</th>
...
<script type="text/javascript">
	...
	var urlIndex = '{{route("admin.files.index")}}';
	var urlCreate ='{{route("admin.files.create")}}';
	var urlDeleteMulti = '{{route("admin.files.delete")}}';
	var path_image = '{{asset(_upload_image)}}/';
	var idRows = [];
	...
	editItem = function(id){
		document.location = '/admin/files/' + id + '/edit';
	}
			...
			columns: [
	            ...
	            { "data": null, render: function(data, type, row){
	            		if(data.file_type == 'Image'){
	            			return text = '<img id="avatar-image" src="' + path_image + data.file_name + '" />'
	            		}else{
	            			return text = '<i class="fa fa-file"></i>';
	            		}
		            } 
		        },
				{ 
