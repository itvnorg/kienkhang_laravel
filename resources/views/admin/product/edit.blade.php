...
<div class="col-md-12 box box-info">
	...
	{{Form::model($data, [
		'url' => route('admin.products.index').'/'.$data->id,
		'method' => 'PUT',
	...
	<div class="col-md-8">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<ul class="box-img">
							...
							<li>
								<a href="#" class="a-delete" data-id="{{$photo->id}}"><i class="fa fa-times"></i></a>
								<a href="{{asset($path_photo.$photo->photo)}}" class="fancy">
									<img src="{{asset($path_photo.$photo->photo)}}" width="120" class="img-thumbnail"/>
								</a>
							</li>
							@endforeach
						</ul>
		...
		<div class="box-footer">
			<a href="{{route('admin.products.index')}}" class="btn btn-default">@lang('admin.cancle')</a>
