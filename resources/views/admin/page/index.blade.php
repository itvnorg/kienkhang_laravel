...
<script type="text/javascript">
	...
	var urlIndex = '{{route("admin.pages.index")}}';
	var urlCreate ='{{route("admin.pages.create")}}';
	var urlDeleteMulti = '{{route("admin.pages.delete")}}';
	var idRows = [];
	...
	editItem = function(id){
		document.location = '/admin/pages/' + id + '/edit';
	}
