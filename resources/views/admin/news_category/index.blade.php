...
<script type="text/javascript">
	...
	var urlIndex = '{{route("admin.news_categories.index")}}';
	var urlCreate ='{{route("admin.news_categories.create")}}';
	var urlDeleteMulti = '{{route("admin.news_categories.delete")}}';
	var idRows = [];
	...
	editItem = function(id){
		document.location = '/admin/news-categories/' + id + '/edit';
	}
