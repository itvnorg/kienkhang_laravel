...
<script type="text/javascript">
	...
	var urlIndex = '{{route("admin.product_categories.index")}}';
	var urlCreate ='{{route("admin.product_categories.create")}}';
	var urlDeleteMulti = '{{route("admin.product_categories.delete")}}';
	var idRows = [];
	...
	editItem = function(id){
		document.location = '/admin/product-categories/' + id + '/edit';
	}
