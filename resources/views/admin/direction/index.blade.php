...
<script type="text/javascript">
	...
	var urlIndex = '{{route("admin.directions.index")}}';
	var urlCreate ='{{route("admin.directions.create")}}';
	var urlDeleteMulti = '{{route("admin.directions.delete")}}';
	var idRows = [];
	...
	editItem = function(id){
		document.location = '/admin/directions/' + id + '/edit';
	}
