...
<script type="text/javascript">
	...
	var urlIndex = '{{route("admin.districts.index")}}';
	var urlCreate ='{{route("admin.districts.create")}}';
	var urlDeleteMulti = '{{route("admin.districts.delete")}}';
	var idRows = [];
	...
	editItem = function(id){
		document.location = '/admin/districts/' + id + '/edit';
	}
