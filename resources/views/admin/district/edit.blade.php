...
<div class="col-md-12 box box-info">
	...
	{{Form::model($data, [
		'url' => route('admin.districts.index').'/'.$data->id,
		'method' => 'PUT',
	...
	<div class="col-md-6">
		<div class="box-body">
			...
			<div class="form-group">
				{{Form::label('province_id', trans('admin.province'), ['class' => 'control-label col-sm-2 required'])}}
				<div class="col-sm-9">
					{{Form::select('province_id', $parent, null, [
						'class' => 'form-control',
		...
		<div class="box-footer">
			<a href="{{route('admin.districts.index')}}" class="btn btn-default">@lang('admin.cancle')</a>
