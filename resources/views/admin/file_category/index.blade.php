...
<script type="text/javascript">
	...
	var urlIndex = '{{route("admin.file_categories.index")}}';
	var urlCreate ='{{route("admin.file_categories.create")}}';
	var urlDeleteMulti = '{{route("admin.file_categories.delete")}}';
	var idRows = [];
	...
	editItem = function(id){
		document.location = '/admin/file-categories/' + id + '/edit';
	}
