...
<script type="text/javascript">
	...
	var urlIndex = '{{route("admin.provinces.index")}}';
	var urlCreate ='{{route("admin.provinces.create")}}';
	var urlDeleteMulti = '{{route("admin.provinces.delete")}}';
	var idRows = [];
	...
	editItem = function(id){
		document.location = '/admin/provinces/' + id + '/edit';
	}
	...
	deleteItem = function(id){
		...
		var dtTable = $('#dataTable').DataTable({
			...
			columns: [
				...
				{ 
					"data": null, render: function(data, type, row) {
						text = (data.type == 1) ? 'Province' : 'City';
						return text;
					} 
				},
				{ 
