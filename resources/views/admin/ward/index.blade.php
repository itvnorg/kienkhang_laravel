...
<script type="text/javascript">
	...
	var urlIndex = '{{route("admin.wards.index")}}';
	var urlCreate ='{{route("admin.wards.create")}}';
	var urlDeleteMulti = '{{route("admin.wards.delete")}}';
	var idRows = [];
	...
	editItem = function(id){
		document.location = '/admin/wards/' + id + '/edit';
	}
	...
	deleteItem = function(id){
		...
		var dtTable = $('#dataTable').DataTable({
			...
			columns: [
				...
				{ 
					"data": null, render: function(data, type, row) {
						text = (data.type == 1) ? 'District' : 'Ward';
						return text;
					} 
				},
				{ 
